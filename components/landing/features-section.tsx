...
const features = [
  {
    ...
    description: "Real-time visualization of transformers and consumer meters with Google Maps integration. Health status color-coding and drill-down to detailed metrics.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI-Powered Dynamic Pricing",
    description: "Responds to real-time grid conditions to incentivize consumption during low-demand periods. Forecasted rates and peak shaving recommendations.",
    visual: "ai",
  },
  {
    number: "03",
    title: "IoT Device Control",
    description: "Connect and manage smart home devices with automated load shedding. Device scheduling, automation, and energy consumption tracking per device.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Intelligent Alerts",
    description: "Real-time notifications for critical grid events. Customizable alert thresholds, alert history analytics, and mobile push notifications.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">grid management</span>
          </h2>
        </div>
